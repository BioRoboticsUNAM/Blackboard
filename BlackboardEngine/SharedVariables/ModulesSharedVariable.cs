...
{
	/// <summary>
	/// Implements a shared variable for the list of modules
	/// </summary>
	internal class ModulesSharedVariable : SharedVariable
	{
		#region Constructors

		/// <summary>
		/// Initializes a new Instance of ModulesSharedVariable
		/// </summary>
		/// <param name="owner">The IModule object which this SharedVariable object is bound to</param>
		public ModulesSharedVariable(ModuleBlackboard owner)
			: base(owner, "string", "modules", false, -1)
		{
		...
		public override string ReadStringData()
		{
			...
			List<string> moduleList = new List<string>(owner.Parent.Modules.Count);
