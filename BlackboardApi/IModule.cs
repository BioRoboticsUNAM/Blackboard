...
namespace Blk.Api
{
	...
	public delegate void CommandReceivedEH(IModule sender, ITextCommand c);
	...
	public delegate void ResponseReceivedEH(IModule sender, ITextResponse r);
	...
	public delegate void StatusChangedEH(IModule sender);
